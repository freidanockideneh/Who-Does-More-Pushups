...
counts <- table(pushups$position)
barplot(counts, main="Freida's Box Graph #1", 
...
qplot(main="Freida's qPlot Graph #1", position, weight, data = pushups)
```
...
I really hope I did think in some of right direction. I like making the box plots and other graphs, some of them are complicating but I like figuring the simplies form and building them. I do clearly see that Skill players do more pushups than Line players. 